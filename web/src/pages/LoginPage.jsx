    ...
    <main className="bn-page">
      <div className="bn-stage" style={{ display: 'flex', minHeight: '100vh', alignItems: 'center', justifyContent: 'center' }}>
        <section style={{ width: '100%', maxWidth: '420px' }}>
          <h1 style={{ fontSize: '2rem', fontWeight: 700, color: '#111827', marginBottom: '0.5rem' }}>Welcome Back</h1>
          <p style={{ fontSize: '0.95rem', color: '#6b7280', marginBottom: '2rem' }}>Sign in to continue managing your documents.</p>
          ...
          <p style={{ marginTop: '1.5rem', fontSize: '0.9rem', color: '#6b7280' }}>
            Need an account?{' '}
            <Link to="/register" style={{ color: '#7c3aed', textDecoration: 'none', fontWeight: 600 }}>
              Register
            </Link>
          </p>
        </section>
