...
export default function BlockEditor({
  ...
  return (
    <section className="editor-shell">
      ...
      {rewriteDialogOpen ? (
        <div className="bn-rewrite-overlay" role="dialog" aria-modal="true" aria-labelledby="rewrite-title">
          <div className="bn-rewrite-dialog">
            <div className="bn-rewrite-header">
              <div>
                <p className="bn-rewrite-kicker">AI block rewrite assistant</p>
                <h3 id="rewrite-title">Rewrite selected block</h3>
              </div>
              <button
                type="button"
            ...
            <label className="bn-rewrite-label" htmlFor="rewrite-mode">
              Rewrite mode
            </label>
            <select
              id="rewrite-mode"
            ...
            <div className="bn-rewrite-grid">
              <section>
                <p className="bn-rewrite-section-title">Original</p>
                <div className="bn-rewrite-box">{rewriteOriginal || 'No source text available.'}</div>
              </section>
              <section>
                <p className="bn-rewrite-section-title">Preview</p>
                <div className="bn-rewrite-box bn-rewrite-box-preview">
                  {rewriteLoading ? 'Generating rewrite...' : rewritePreview || 'Generate a rewrite to preview the result.'}
                </div>
              </section>
            </div>

            {rewriteError ? <p className="bn-rewrite-error">{rewriteError}</p> : null}

            <div className="bn-rewrite-actions">
              <button type="button" className="bn-rewrite-secondary" onClick={generateRewrite} disabled={rewriteLoading}>
                {rewritePreview ? 'Regenerate' : 'Generate'}
              </button>
              <button type="button" className="bn-rewrite-primary" onClick={applyRewrite} disabled={rewriteLoading || !rewritePreview}>
                Apply rewrite
              </button>
            </div>
          </div>
